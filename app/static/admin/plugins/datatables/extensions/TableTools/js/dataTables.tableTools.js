...
var ZeroClipboard_TableTools = {
	...
	moviePath: '', // URL to home
	nextId: 1, // ID of next home
	...
	dispatch: function(id, eventName, args) {
		// receive event from flash home, send to client
...
ZeroClipboard_TableTools.Client.prototype = {
	...
	ready: false, // whether home is ready to receive events or not
	movie: null, // reference to home object
	...
	getHTML: function(width, height) {
		...
		if (navigator.userAgent.match(/MSIE/)) {
			...
			html += '<object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" codebase="'+protocol+'download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=10,0,0,0" width="'+width+'" height="'+height+'" id="'+this.movieId+'" align="middle"><param name="allowScriptAccess" value="always" /><param name="allowFullScreen" value="false" /><param name="home" value="'+ZeroClipboard_TableTools.moviePath+'" /><param name="loop" value="false" /><param name="menu" value="false" /><param name="quality" value="best" /><param name="bgcolor" value="#ffffff" /><param name="flashvars" value="'+flashvars+'"/><param name="wmode" value="transparent"/></object>';
		}
		else {
	...
	receiveEvent: function(eventName, args) {
		...
		switch (eventName) {
			case 'load':
				// home claims it is ready, but in IE this isn't always the case...
...
TableTools.prototype = {
	 ...
	 *  @param   {String} text title of the flash home
	 *  @returns void
	 *  @private 
	 */
